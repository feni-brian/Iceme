...
struct ContentView: View {
    ...
    /// The view body.
    ///
    /// This view embeds a [`NavigationSplitView`](https://developer.apple.com/documentation/swiftui/navigationsplitview), which displays the ``Sidebar`` view in the
    /// left column, and a [`NavigationStack`](https://developer.apple.com/documentation/swiftui/navigationstack) in the detail column,
    /// which consists of ``DetailColumn``, on macOS and iPadOS.
    /// On iOS the [`NavigationSplitView`](https://developer.apple.com/documentation/swiftui/navigationsplitview) display a navigation stack
    /// with the ``Sidebar`` view as the root.
    var body: some View {
        NavigationSplitView {
        ...
        .onChange(of: scenePhase) { newValue in
            // If this view becomes active, tell the Messages manager to display store messages in this window.
            if newValue == .active { StoreMessagesManager.shared.displayAction = displayStoreMessage }
        }
