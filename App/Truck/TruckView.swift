...
//  Iceme Corner
//
//  Created by Feni Brian on 25/07/2023.
//
...
struct TruckView: View {
    ...
    var orders: some View { TruckOrdersCard(model: model, navigation: cardNavigation) }
    var weather: some View { TruckWeatherCard(location: model.truck.location.location, navigation: cardNavigation) }
    var donuts: some View { TruckDonutsCard(donuts: model.donuts, navigation: cardNavigation) }
    var socialFeed: some View { TruckSocialFeedCard(navigation: cardNavigation) }
...
struct TruckView_Previews: PreviewProvider {
    struct Preview: View {
        ...
        @State private var navigationSelection: Panel? = .truck
        var body: some View {
