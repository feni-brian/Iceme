            ...
            VStack(spacing: 10) {
                ...
                .overlay(alignment: .bottomTrailing) {
                    if let currentWeatherCondition = condition, let willRainSoon = willRainSoon, let symbolName = symbolName {
                        CityWeatherCard(condition: currentWeatherCondition, willRainSoon: willRainSoon, symbolName: symbolName)
                            .padding(.bottom)
                    }
                }
                ...
                VStack {
                    RecommendedParkingSpotCard(
                        ...
                        temperature: temperature ?? Measurement(value: 32, unit: .celsius),
